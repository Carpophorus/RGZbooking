  ...
  function handleResponse(request, responseHandler, isJsonResponse) {
    if (request.readyState == 4) {
      if (request.status == 200 || request.status == 201 || request.status == 204) {
        ...
        $.confirm({
          title: 'ГРЕШКА!',
          content: 'Десила се грешка у систему, покушајте поново касније.<span>Како би услуга била омогућена, потребно је користити новије верзије интернет претраживача (Chrome, Firefox, Edge и сл. са почетка 2016. године или новији).</span>',
          theme: 'supervan',
          backgroundDismiss: 'true',
          buttons: {
            ok: {
